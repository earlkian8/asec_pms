...
export default function ClientsIndex() {
  ...
  const initializeFilters = (filterProps) => {
    return {
      client_type: filterProps?.client_type || '',
  ...
  }, [filters.client_type, filters.is_active, filters.city, filters.province]);
  ...
  const activeFiltersCount = () => {
    let count = 0;
    if (localFilters.client_type && localFilters.client_type !== 'all') count++;
                        ...
                        <div className="p-4 overflow-y-auto flex-1">
                          ...
                          {filterOptions.clientTypes && filterOptions.clientTypes.length > 0 && (
                            <div className="mb-4">
                              ...
                              <Select
                                value={localFilters.client_type || 'all'}
                                onValueChange={(value) => handleFilterChange('client_type', value)}
                              >
                      ...
                      >
                        ...
                        <TableCell className="text-left px-4 py-4 text-sm">
                          <span className="px-3 py-1.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200">
                            {capitalizeText(client.client_type)}
                          </span>
                        </TableCell>
