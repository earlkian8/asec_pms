...
import { Trash2, SquarePen, Filter, X, Search, Truck, TrendingUp, AlertCircle, ArrowUpDown, PackagePlus } from 'lucide-react';
...
export default function DirectSupplyManagement() {
  ...
  const pagination = usePage().props.supplies;
                      ...
                      <TableRow key={supply.id}
                        ...
                        <TableCell className="text-left px-4 py-4 text-sm">
                          ...
                          {supply.supplier_contact && (
                            <div className="text-xs text-gray-500">{supply.supplier_contact}</div>
                          )}
                        </TableCell>
                        <TableCell className="text-left px-4 py-4 text-sm">
                          <div className="flex items-center gap-2">
                        ...
                        <TableCell className="text-left px-4 py-4 text-sm">
                          <div className="flex gap-1.5">
                            ...
                            {has('direct-supply.delete') && (
                              <button onClick={() => { setDeleteSupply(supply); setShowDeleteModal(true); }}
                                className="p-1.5 rounded-lg hover:bg-red-100 text-red-600 hover:text-red-700 transition-all duration-200 hover:scale-110 border border-red-200 hover:border-red-300"
                                title="Delete">
                                <Trash2 size={16} />
                              </button>
                            )}
