...
const EditMiscellaneousExpense = ({ setShowEditModal, project, expense }) => {
  ...
  const handleSubmit = (e) => {
    ...
    put(route("project-management.miscellaneous-expenses.update", [project.id, expense.id]), {
      preserveScroll: true,
      onSuccess: (page) => {
  ...
  return (
    <Dialog open onOpenChange={setShowEditModal}>
      <DialogContent className="w-[95vw] max-w-[500px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-zinc-800">Edit Miscellaneous Expense</DialogTitle>
