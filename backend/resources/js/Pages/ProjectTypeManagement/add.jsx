...
const AddProjectType = ({ setShowAddModal }) => {
  ...
  const handleSubmit = (e) => {
    ...
    post(route('project-type-management.store'), {
      onSuccess: () => {
  ...
  return (
    <Dialog open onOpenChange={setShowAddModal}>
      <DialogContent className="w-[95vw] max-w-[600px]">
        <DialogHeader>
          <DialogTitle className="text-zinc-800">Add Project Type</DialogTitle>
          <DialogDescription className="text-zinc-600">
            Enter the details for the new project type below.
          </DialogDescription>
        </DialogHeader>
